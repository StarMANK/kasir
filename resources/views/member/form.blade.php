        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="gender" class="col-lg-2 col-lg-offset-1 control-label">Jenis Kelamin</label>
                        <div class="col-lg-6">
                            <input type="checkbox" name="gender" value="Wanita" checked> Wanita <br>
                            <input type="checkbox" name="gender" value="Laki-Laki"> Laki-Laki
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
